...
if(isset($_REQUEST['customStart'])) {
    ...
    if (isset($customParams)) {
        ...
        exit(json_encode(array('ticketShortId' => $ticketShortId,'ticketPath'=>$ticketPath,'ticketToken' => $ticketToken)));
...
if(isset($_REQUEST['custom']) && $_REQUEST['custom'] == "reinit") {
    ...
    exit(json_encode(array("id"=>$params->getTicketId(),"path" => $params->getTicketPath(),"token" => $params->getTicketToken()),JSON_PRETTY_PRINT));
}
